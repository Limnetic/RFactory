...
import com.lyrarmastudio.rfactory.fluid.OilFluid;
import com.lyrarmastudio.rfactory.RfactoryMod;

public class RfactoryModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, RfactoryMod.MODID);

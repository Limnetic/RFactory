...
public class RfactoryModItems {
	...
	public static final RegistryObject<Item> CHEMICALPLANT = block(RfactoryModBlocks.CHEMICALPLANT, RfactoryModTabs.TAB_R_FACTORY);
	...
	public static final RegistryObject<Item> REDSTONE_IRON_BLOCK = block(RfactoryModBlocks.REDSTONE_IRON_BLOCK, RfactoryModTabs.TAB_R_FACTORY);
	public static final RegistryObject<Item> SOLAR_PANEL = block(RfactoryModBlocks.SOLAR_PANEL, RfactoryModTabs.TAB_R_FACTORY);
	public static final RegistryObject<Item> ENERGY_METR = REGISTRY.register("energy_metr", () -> new EnergyMetrItem());
	public static final RegistryObject<Item> SMALL_BATTERY = block(RfactoryModBlocks.SMALL_BATTERY, RfactoryModTabs.TAB_R_FACTORY);
